...
* Audio
  * Try out shorter envelope stage minimum lengths, possibly 3ms. Change both
    interpolation time and parameter value minimum, and possibly key velocity
    interpolation time too.
  * Should one-shot LFOs keep returning end value?
* GUI
  * Wave display
