...
impl<H: GuiSyncHandle> OctaSineIcedApplication<H> {
    fn set_value(&mut self, parameter_index: usize, value: f64) {
        ...
        match parameter_index {
            ...
            3 => self.operator_1.operator_button.set_value(v),
            4 => {
            ...
            17 => self.operator_2.operator_button.set_value(v),
            18 => {
            ...
            33 => self.operator_3.operator_button.set_value(v),
            34 => {
            ...
            49 => self.operator_4.operator_button.set_value(v),
            50 => {
