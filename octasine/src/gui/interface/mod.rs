...
impl <H: GuiSyncHandle> OctaSineIcedApplication<H> {
    fn set_value(
        ...
        match parameter_index {
            ...
            59 => self.lfo_1.target.set_value(h, v),
            60 => self.lfo_1.shape.set_value(h, v),
            61 => self.lfo_1.mode.set_value(h, v),
            ...
            66 => self.lfo_2.target.set_value(h, v),
            67 => self.lfo_2.shape.set_value(h, v),
            68 => self.lfo_2.mode.set_value(h, v),
            ...
            73 => self.lfo_3.target.set_value(h, v),
            74 => self.lfo_3.shape.set_value(h, v),
            75 => self.lfo_3.mode.set_value(h, v),
            ...
            80 => self.lfo_4.target.set_value(h, v),
            81 => self.lfo_4.shape.set_value(h, v),
            82 => self.lfo_4.mode.set_value(h, v),
