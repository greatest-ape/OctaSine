...
/// Attempt to split packed simd gen implementation into separate function.
...
/// Audio generation using simdeez
/// 
/// Notes:
///   - At least SSE2 is required. Scalar fallback will fail due to the method
///     used for stereo modulation input calculation.
/// 
/// TODO:
    ...
    simd_runtime_generate!(
        pub fn process(
            ...
            for pass_index in 0..num_passes {
                ...
                for (voice_index, voice) in octasine.processing.voices.iter_mut().enumerate(){
                    if voice.active {
