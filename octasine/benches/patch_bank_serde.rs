...
fn export_plain(c: &mut Criterion) {
    ...
    c.bench_with_input(BenchmarkId::new("export_plain", "randomized"), &bank, |b, bank| {
...
fn export_fxb(c: &mut Criterion) {
    ...
    c.bench_with_input(BenchmarkId::new("export_fxb", "randomized"), &bank, |b, bank| {
...
fn import_plain(c: &mut Criterion) {
    ...
    c.bench_with_input(BenchmarkId::new("import_plain", "randomized"), &data, |b, data| {
...
fn import_fxb(c: &mut Criterion) {
    ...
    c.bench_with_input(BenchmarkId::new("import_fxb", "randomized"), &data, |b, data| {
        b.iter(|| PatchBank::new_from_bytes(&data));
    });
}
