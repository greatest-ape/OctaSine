...
pub const OPERATOR_DEFAULT_VOLUME: f32 = 1.0;
pub const OPERATOR_DEFAULT_SKIP_CHAIN_FACTOR: f32 = 0.0;
pub const OPERATOR_DEFAULT_ADDITIVE_FACTOR: f32 = 0.0;
pub const OPERATOR_DEFAULT_PANNING: f32 = 0.5;
pub const OPERATOR_DEFAULT_FREQUENCY_RATIO: f32 = 1.0;
pub const OPERATOR_DEFAULT_FREQUENCY_FREE: f32 = 1.0;
pub const OPERATOR_DEFAULT_FREQUENCY_FINE: f32 = 1.0;
pub const OPERATOR_DEFAULT_FEEDBACK: f32 = 0.0;
pub const OPERATOR_DEFAULT_MODULATION_INDEX: f32 = 1.0;
pub const OPERATOR_DEFAULT_WAVE_TYPE: WaveType = WaveType::Sine;

pub const OPERATOR_3_DEFAULT_MOD_TARGET: usize = 1;
pub const OPERATOR_4_DEFAULT_MOD_TARGET: usize = 2;
