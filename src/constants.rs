...
pub const OPERATOR_ENVELOPE_MIN_DURATION: f64 = 0.01;

pub const OPERATOR_DEFAULT_VOLUME_ENVELOPE_ATTACK_DURATION: f64 = OPERATOR_ENVELOPE_MIN_DURATION;
pub const OPERATOR_DEFAULT_VOLUME_ENVELOPE_ATTACK_VALUE: f64 = 1.0;
pub const OPERATOR_DEFAULT_VOLUME_ENVELOPE_DECAY_DURATION: f64 = OPERATOR_ENVELOPE_MIN_DURATION;
